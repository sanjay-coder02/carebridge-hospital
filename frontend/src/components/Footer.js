        ...
        <footer className="carebridge-footer">
            <Container>
                <Row className="g-4">
                    <Col md={5}>
                        ...
                        <p className="footer-description">
                            Compassionate healthcare delivered by trusted
                            medical professionals with patient care at the
                ...
                <div className="footer-bottom">
                    <p>
                        © {new Date().getFullYear()} CareBridge Hospital.
                        All rights reserved.
                    </p>
